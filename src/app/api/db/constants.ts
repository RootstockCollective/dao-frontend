...
const BACKERS_REWARDS_CLAIMED_TOKEN = 'token'
const BACKERS_REWARDS_CLAIMED_AMOUNT = 'amount'
const BACKERS_REWARDS_CLAIMED_BUILDER = 'builder'
export const BACKERS_REWARDS_CLAIMED_COLUMNS = [
  COLUMN_ID,
  BACKERS_REWARDS_CLAIMED_TOKEN,
  BACKERS_REWARDS_CLAIMED_AMOUNT,
  BACKERS_REWARDS_CLAIMED_BUILDER,
]
