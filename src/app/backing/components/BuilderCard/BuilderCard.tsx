...
export const BuilderCard: FC<BuilderCardProps> = ({
  ...
  return (
    <div
      className={cn(
        'rounded bg-v3-bg-accent-60 px-2 pb-6 flex flex-col items-center relative min-w-[200px] min-h-[554px]',
        className,
      )}
    ...
    >
      ...
      <div className="my-6 w-full">
        ...
        >
          {isRewardable && <RewardsInfo {...backerRewardPct} estimatedRewards={estimatedRewards} />}
