...
const DEFAULT_DEBRIS_SECONDARY = '#25211E'

export interface DecorativeSquaresProps extends IconProps {
  /** Main debris color (cream/light squares). */
  color?: string
  /** Secondary debris color (dark square, e.g. to blend with page background). */
...
export function DecorativeSquares({
  ...
  secondaryColor = DEFAULT_DEBRIS_SECONDARY,
  ...props
  ...
  return (
    ...
    >
      ...
      <g clipPath="url(#clip0_2219_1646)">
        ...
        <rect width="10" height="10" transform="matrix(-1 0 0 1 10 30)" fill={secondaryColor} />
