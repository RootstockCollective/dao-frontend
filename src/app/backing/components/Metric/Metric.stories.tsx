  ...
  args: {
    ...
    title: (
      <MetricTitle
        dataTestId="TVL"
        title="Custom Metric"
        info="This is a custom metric with complex content"
      />
    ),
    content: (
...
export const WithMetricTitleText: Story = {
  args: {
    dataTestId: 'TVL',
    title: <MetricTitleText dataTestId="TVL" text="Using MetricTitleText Component" />,
    content: <div className="text-2xl font-bold">$1,234,567</div>,
  },
}
...
export const WithTrendingMetric: Story = {
  args: {
    dataTestId: 'TVL',
    title: <MetricTitle dataTestId="TVL" title="Growth Rate" info="Monthly growth rate of the protocol" />,
    content: (
      <div className="flex items-center gap-2">
  ...
  args: {
    ...
    title: (
      <div className="flex items-center gap-2">
        ...
        <MetricTitleText dataTestId="TVL" text="Community Stats" />
      </div>
    ),
    content: (
      <div className="flex items-center gap-2">
...
export const Tested: Story = {
  args: {
    dataTestId: 'TVL',
    title: <MetricTitle dataTestId="TVL" title="Test Metric" info="Test info" />,
    content: <div>Test content</div>,
  },
  play: async ({ canvasElement }) => {
    const canvas = within(canvasElement)
    const metric = canvas.getByTestId('TVL_Metric')
