...
/**
 * Two-step indicator for the BTC vault deposit modal.
 * Mirrors the pattern from StakeSteps / SwapSteps.
 */
export const DepositSteps = ({ currentStep }: DepositStepsProps) => (
