...
import { AllocationsContext, AllocationsContextProviderWithBuilders } from './context'
...
export default function Allocations() {
  ...
  return (
    ...
    <AllocationsContextProviderWithBuilders>
      <MainContainer>
            ...
            <div className="flex items-start content-start flex-wrap gap-4">
              {Object.entries(allocations).map(([key, currentAllocation]) => {
                ...
                const builder: BuilderAllocationProps = {
                  ...
                  index,
                  currentAllocation,
                  // TODO: we need to retrieve the joining date
