...
const meta: Meta<typeof TotalBackingContent> = {
  ...
  parameters: {
    ...
    docs: {
      description: {
        component:
          'Displays the total backing amount in StRIF tokens with proper formatting and token icon. This is the presentational component that receives the totalAllocations as a prop.',
      },
    },
  },
  argTypes: {
...
export const Interactive: Story = {
  ...
  render: args => {
    const bigIntValue =
      typeof args.totalAllocations === 'string' ? parseBigInt(args.totalAllocations) : args.totalAllocations
