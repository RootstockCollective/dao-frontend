...
const FUND_MANAGER_TABS = ['Transactions', 'NAV History', 'On going'] as const
type FundManagerTab = (typeof FUND_MANAGER_TABS)[number]

/**
 * Tabbed section for Fund Manager: Transactions, NAV History, On going.
  ...
  return (
    ...
    >
      <div className="mt-6 p-6 pt-4 bg-bg-80 rounded-sm">
        ...
        {activeTab === 'On going' && 'On going table'}
      </div>
    </SolidTabs>
  )
}
