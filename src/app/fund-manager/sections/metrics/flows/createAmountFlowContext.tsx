...
import { RbtcToken, useRbtcTokenSelection } from '../hooks/useRbtcTokenSelection'
...
export interface AmountFlowContextValue {
  ...
  setSelectedToken: (token: RbtcToken) => void
}
...
export const createAmountFlowContext = (displayName: string) => {
  ...
  const Provider = ({ children }: { children: ReactNode }) => {
    ...
    const tokenSelection = useRbtcTokenSelection()
