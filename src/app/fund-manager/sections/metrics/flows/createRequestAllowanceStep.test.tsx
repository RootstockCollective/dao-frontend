...
vi.mock('@/app/fund-manager/sections/metrics/hooks/useErc20Allowance', () => ({
...
describe('createRequestAllowanceStep', () => {
  ...
  describe('component creation', () => {
    it('creates a component that can be rendered', async () => {
      const { useErc20Allowance } = await import('@/app/fund-manager/sections/metrics/hooks/useErc20Allowance')
