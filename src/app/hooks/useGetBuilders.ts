import { BackerRewardPercentage, Builder, BuilderStateFlags } from '@/app/types'
import { useGetGaugesArray } from '@/app/hooks/useGetGaugesArray'
import { getMostAdvancedProposal, removeBrackets } from '@/app/utils'
...
import { useGetProposalsState } from '@/app/hooks'
