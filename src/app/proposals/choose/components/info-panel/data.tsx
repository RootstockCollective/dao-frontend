    ...
    },
    {
      ...
      Text: props => (
        <span {...props}>
          ...
          previously been created. If you haven’t done this yet, don’t worry its pretty easy and you can
    ...
    },
    {
      ...
      Text: props => (
        <span {...props}>
          ...
          not pass, KYC is not required however its best to get familiar with this now and get started on this
