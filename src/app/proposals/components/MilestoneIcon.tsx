 ...
 */
export function MilestoneIcon({ digit, ...props }: Props) {
  const [symbol] = digit // take first symbol
  return (
    <svg width="16" height="21" viewBox="0 0 16 21" fill="none" xmlns="http://www.w3.org/2000/svg" {...props}>
      <path
        ...
        fill="url(#paint0_linear_3305_1127)"
      />
      ...
      <defs>
        <linearGradient
          id="paint0_linear_3305_1127"
          x1="8.00001"
          y1="0.50001"
          x2="3.71683"
          y2="19.5363"
          gradientUnits="userSpaceOnUse"
          gradientTransform="matrix(1, 0, 0, 1, -0.012226, 0.002133)"
        >
          <stop stopColor="#FFFEE3" />
          <stop offset="0.2452" stopColor="#E88DFF" />
