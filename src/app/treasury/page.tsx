...
const TreasurySection = () => (
  <div>
    <Header variant='h2' className='mb-[17px]'>Treasury</Header>
...
const TotalTokenHoldingsSection = () => (
  <div>
    <Header variant='h2' className='mb-[17px]'>Total token holdings</Header>
...
const Distribution = () => (
  <div>
    ...
    <Header variant='span' className='mb-[17px]'>Payouts from the treasury</Header>
    <Table data={tableData} />
  </div>
)
