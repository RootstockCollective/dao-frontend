...
export const JoinACommunity = () => (
  <div className='flex justify-center align-center'>
    <div className='w-[506px] flex align-middle items-center flex-col'>
      ...
      <Paragraph variant='light' className='text-center pb-[40px] text-[20px]'>You&apos;re not currently part of any communities. Join a community to connect with like-minded individuals, participate in discussions, and gain access to exclusive content.</Paragraph>
