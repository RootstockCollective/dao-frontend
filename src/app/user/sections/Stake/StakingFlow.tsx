...
import { StakingProvider } from '@/app/user/sections/Stake/StakingContext'
import { useSteps } from '@/app/user/sections/Stake/hooks/useSteps'
import { useBalancesContext } from '@/app/user/contexts/BalancesContext'
import { StakingToken } from '@/app/user/sections/Stake/types'
