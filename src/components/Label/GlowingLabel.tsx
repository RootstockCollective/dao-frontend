...
export const GlowingLabel: FC<GlowingLabelProps> = ({ children, showGlow, faded }) => (
  <div
    data-testid="glowingLabel"
    className={`text-[#4b171a] text-base  ${faded ? 'font-normal font-kk-topo uppercase' : 'font-bold font-rootstock-sans'}`}
    style={{
      background: faded
