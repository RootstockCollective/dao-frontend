export const BufferAbi = [
  ...
  { inputs: [], name: 'InsufficientBufferBalance', type: 'error' },
  ...
  { inputs: [], name: 'ZeroAssets', type: 'error' },
  {
    anonymous: false,
    inputs: [
      { indexed: true, internalType: 'address', name: 'creditTo', type: 'address' },
      { indexed: false, internalType: 'uint256', name: 'assets', type: 'uint256' },
      { indexed: false, internalType: 'uint256', name: 'newBufferAssets', type: 'uint256' },
    ],
    name: 'BufferCredited',
    type: 'event',
  },
  ...
  },
  {
    ...
    inputs: [
      ...
      { indexed: true, internalType: 'address', name: 'creditedTo', type: 'address' },
      { indexed: false, internalType: 'uint256', name: 'assets', type: 'uint256' },
    ],
    name: 'BufferInjected',
    type: 'event',
  ...
  {
    inputs: [{ internalType: 'address', name: 'injector', type: 'address' }],
    name: 'bufferCredits',
    outputs: [{ internalType: 'uint256', name: '', type: 'uint256' }],
    stateMutability: 'view',
    type: 'function',
