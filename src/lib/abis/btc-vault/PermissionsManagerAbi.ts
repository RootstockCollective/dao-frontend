export const PermissionsManagerAbi = [
  ...
  },
  {
    ...
    inputs: [
      ...
      { name: 'whitelistingOperator', type: 'address', internalType: 'address' },
      { name: 'pauser', type: 'address', internalType: 'address' },
      { name: 'bufferInjector', type: 'address', internalType: 'address' },
      { name: 'adminTransferDelay', type: 'uint48', internalType: 'uint48' },
