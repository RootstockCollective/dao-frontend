export const PermissionsManagerAbi = [
  ...
  },
  {
    inputs: [
      ...
      { internalType: 'address', name: 'whitelistingOperator', type: 'address' },
      { internalType: 'address', name: 'pauser', type: 'address' },
      { internalType: 'address', name: 'bufferInjector', type: 'address' },
      { internalType: 'uint48', name: 'adminTransferDelay', type: 'uint48' },
