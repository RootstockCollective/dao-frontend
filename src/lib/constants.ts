...
const DEFAULT_STATE_SYNC_GRAPH_STALENESS_THRESHOLD = 100
export const STATE_SYNC_GRAPH_STALENESS_THRESHOLD = Number(
  process.env.NEXT_PUBLIC_STATE_SYNC_GRAPH_STALENESS_THRESHOLD ??
    DEFAULT_STATE_SYNC_GRAPH_STALENESS_THRESHOLD,
)
