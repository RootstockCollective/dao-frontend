...
export const VAULT_DEPOSIT_LIMITER_ADDRESS =
  (process.env.NEXT_PUBLIC_VAULT_DEPOSIT_LIMITER_ADDRESS as Address) || zeroAddress
...
export const VAULT_KYC_URL = 'https://example.com'
